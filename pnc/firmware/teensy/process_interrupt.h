...
// later initialization.  The active-HIGH DRV200 modulation path is preloaded
// LOW before output drive is enabled.  This is temporary boot custody; subsystem
// runtime ownership begins later.
